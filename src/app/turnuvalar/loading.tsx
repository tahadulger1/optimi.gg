...
export default function TurnuvalarLoading() {
  return (
        ...
        <div className="relative container mx-auto px-4 pt-32 pb-16 lg:pt-40 lg:pb-20">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex flex-wrap gap-6 md:gap-10 pt-4">
              {[Trophy, Users, Gamepad2].map((Icon, index) => (
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div className="space-y-2">
              ...
              <div className="h-4 w-32 bg-muted/50 rounded animate-shimmer" />
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <div className="h-10 w-20 bg-muted/50 rounded-lg animate-shimmer" />
              <div className="h-10 w-20 bg-muted/50 rounded-lg animate-shimmer" />
              <div className="h-10 w-20 bg-muted/50 rounded-lg animate-shimmer" />
            </div>
          </div>
